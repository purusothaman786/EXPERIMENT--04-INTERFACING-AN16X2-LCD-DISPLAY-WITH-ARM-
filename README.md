...
int main(void)
{
  ...
  Lcd_PortType ports[] = {GPIOA,GPIOA,GPIOA,GPIOA};
    ...
    Lcd_cursor(&lcd, 0,0);
    Lcd_string(&lcd, "Purusothaman K");

    Lcd_cursor(&lcd,1,0);
        Lcd_string(&lcd, "212224110046");
        HAL_Delay(500);
  while (1)
  {
...
<img width="1920" height="1200" alt="image" src="https://github.com/user-attachments/assets/07d6353d-2785-4656-b056-67805825b7c6" />


 ## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 
 

[pmc exp4 graph.pdf](https://github.com/user-attachments/files/22375829/pmc.exp4.graph.pdf)
